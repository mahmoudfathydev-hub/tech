            ...
            <div className="container mx-auto">
                <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
                    ...
                    <div
                        ...
                        <div className="flex-1 flex flex-col justify-between rounded-3xl bg-[#2384eb] overflow-hidden shadow-2xl border border-white/10 relative group transition-all duration-500 hover:shadow-[#2384eb]/20">
                            <div className="h-1/2 min-h-45 relative overflow-hidden">
                                <Image
                                    ...
                                    priority
                                />
                                <div className="absolute inset-0 bg-linear-to-t from-[#2384eb] via-transparent to-black/20" />
                            ...
                            <div className="flex-1 p-4 flex flex-col justify-center relative bg-[#2384eb]">
                                <Sale />
                ...
                <div
                    className="mt-4 sm:mt-6 h-32 sm:h-40 xl:h-32 w-full rounded-3xl bg-linear-to-r from-[#2384eb] via-[#1d6fd1] to-[#144a94] flex items-center justify-between px-6 sm:px-12 text-white overflow-hidden relative group cursor-pointer shadow-xl border border-white/10">
